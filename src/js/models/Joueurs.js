...
export default class Joueurs {
    ...
    estProche(coordonnees) {
        ...
        if( (this.position[0] === coordonnees[0] && this.position[1] === coordonnees[1] + 1)
             || (this.position[0] === coordonnees[0] && this.position[1] === coordonnees[1] - 1)
             || (this.position[0] === coordonnees[0] + 1 && this.position[1] === coordonnees[1])
             || (this.position[0] === coordonnees[0] - 1 && this.position[1] === coordonnees[1]) ) {
                 return true;
             } else {
                return false;   
